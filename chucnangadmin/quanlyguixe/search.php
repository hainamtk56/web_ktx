...
<body>
    ...
    if (isset($_GET['search'])) {
        ...
        if(mysqli_num_rows($result) > 0) {?>
            <html>
            <div>
                <form method="GET" action="index.php?action=quanlyguixe">
            ...
            while($row = mysqli_fetch_assoc($result)) {
                ...
                echo "<tr>";
                    ...
                    echo "<td><a href='index.php?action=suaquanlyguixe&BienSo=" . $BienSo . "' target='_blan><button class='btn-sua'>Sửa</button></a></td>";
...
<div>
    ...
    <a href="index.php?action=quanlyguixe"><button class="btn-quaylai"><b>Quay lại trang chủ</b></button></a>
</div>
<script>

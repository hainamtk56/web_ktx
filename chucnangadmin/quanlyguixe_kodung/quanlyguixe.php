        ...
        if(mysqli_num_rows($result) > 0) {?>
            ...
            while($row = mysqli_fetch_assoc($result)) {
                echo "<tr>";
                    ...
                    echo "<td><a href='edit.php?BienSo=".$row["BienSo"]."'><button class='btn-sua'>Sửa</button></a></td>";
                    echo "<td><a onclick='confirmDelete(\"" . $row["BienSo"] . "\")'><button class='btn-xoa'>Xóa</button></a></td>";
                echo "</tr>";
            }
            echo "</tbody>";
            echo "</table>";
...
<div>
    ...
    <a href="quanlyguixe.php"><button class="btn-quaylai"><b>Quay lại trang chủ</b></button></a>
</div>
<script>

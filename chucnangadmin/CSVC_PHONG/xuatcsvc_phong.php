...
$columnHeaders = ['Mã Phòng', 'Mã CSVC', 'Tên CSVC','Số Lượng', 'Ghi Chú'];
...
$sql = "SELECT MaPhong, cosovatchat.MaCSVC, cosovatchat.TenCSVC, SoLuong, GhiChu FROM csvc_phong INNER JOIN cosovatchat ON csvc_phong.MaCSVC=cosovatchat.MaCSVC ORDER BY MaPhong";
...
header('Content-Disposition: attachment; filename="danhsachcsvctheophong.xlsx"');

...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 28, 2023 at 05:11 AM
...
(8, 'SV1', 'A101', NULL, '2023-10-18', NULL, 'chờ duyệt trả'),
(9, 'SV1', 'B101', NULL, '2023-10-18', NULL, 'chờ duyệt trả'),
(10, 'SV1', 'B101', NULL, '2023-10-18', '2023-10-18', 'đã duyệt');
...
(1, 'A101', 10, 500000, 200000, 100000, 'ChuaThu'),
(2, 'A102', 10, 300000, 100000, 100000, 'ChuaThu');
...
('NV10', 'Do Ngoc Khanh', '2023-10-19', 'HN', '012983123', 'NV10'),
('NV2', 'hasdasdasd', '2006-06-06', '121', '121212', 'NV2');
...
('SV1', 'Lê Tuấn Hiệp', '2013-08-15', 'nam', 'quang ninh', 214748, 'letuanhiep@gmail.com', 'A102', 'Khu A', 'SV1'),
...
(6, 'SV1', 'Thông Báo Đổi Mật Khẩu', 'Tài khoản của bạn đã được thay đổi mật khẩu thành công vào 2023-10-18 4:36:26, nếu không phải là bạn đổi hãy lập tức liên lạc với cán bộ ký túc xá, xin cảm ơn!', '2023-10-18'),
(7, 'SV1', 'Thông Báo Đổi Mật Khẩu', 'Tài khoản của bạn đã được thay đổi mật khẩu thành công vào 2023-10-18 4:55:9, nếu không phải là bạn đổi hãy lập tức liên lạc với cán bộ ký túc xá, xin cảm ơn!', '2023-10-18'),
(8, 'SV1', 'Thông Báo Đổi Mật Khẩu', 'Tài khoản của bạn đã được thay đổi mật khẩu thành công vào 2023-10-18 4:55:25, nếu không phải là bạn đổi hãy lập tức liên lạc với cán bộ ký túc xá, xin cảm ơn!', '2023-10-18'),
(9, 'SV1', 'Thông Báo Trả Phòng', 'Yêu cầu trả phòng của bạn đã được phê duyệt. Mọi thắc mắc vui lòng lên gặp Nhân viên Ký túc xá để biết thêm chi tiết. Xin cảm ơn !!!', '2023-10-18'),
(10, 'SV1', 'Thông Báo Trả Phòng', 'Yêu cầu trả phòng của bạn không được phê duyệt. Mọi thắc mắc vui lòng lên gặp Nhân viên Ký túc xá để biết thêm chi tiết. Xin cảm ơn !', '2023-10-18'),
(11, 'SV1', 'Thông Báo Trả Phòng', 'Yêu cầu trả phòng của bạn đã được phê duyệt. Mọi thắc mắc vui lòng lên gặp Nhân viên Ký túc xá để biết thêm chi tiết. Xin cảm ơn !!!', '2023-10-18');
...
--
ALTER TABLE `dangkyphong`
  MODIFY `MaDK` int(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
...
--
ALTER TABLE `thongbao`
  MODIFY `MaTB` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;
